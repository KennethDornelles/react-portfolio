              ...
              >
                <div className="absolute inset-0 flex h-full w-full flex-col items-center justify-center rounded-lg bg-blue-600 bg-opacity-90 text-white opacity-0 transition-opacity group-hover:opacity-100">
                  ...
                  <div className="flex gap-3">
                    {project.link && (
                      <a href={project.link} target="_blank" rel="noopener noreferrer" className="hover:text-blue-200 bg-blue-800 p-2 rounded-full" title={t('projects.viewProject')}>
                        <HiArrowTopRightOnSquare className="h-5 w-5" />
                      </a>
                    )}
                    {project.github && (
                      <a href={project.github} target="_blank" rel="noopener noreferrer" className="hover:text-blue-200 bg-blue-800 p-2 rounded-full" title={t('projects.viewCode')}>
            ...
            {githubProjects.length > 0 && (
              <>
                <div className="col-span-1 md:col-span-3 mt-8">
                  <h3 className="text-xl font-semibold text-white mb-4">{t('projects.others')}</h3>
                </div>
